...
public class UltimateBowItem extends BowItem implements Vanishable {
        public static final int field_30855 = 20;
        public static final int RANGE = 15;

    public UltimateBowItem(Item.Settings settings) {
            super(settings);
        }
                ...
                if (!itemStack.isEmpty() || bl) {
                    ...
                    if (!((double)f < 0.1)) {
                        ...
                        if (!world.isClient) {
                            ...
                            if (j > 0) {
                                persistentProjectileEntity.setDamage(persistentProjectileEntity.getDamage() + (double)j * 10.0 + 3.0);
                            }

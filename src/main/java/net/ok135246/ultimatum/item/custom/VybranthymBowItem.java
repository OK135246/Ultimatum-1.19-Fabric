...
public class VybranthymBowItem extends BowItem implements Vanishable {
    public static final int field_30855 = 20;
    public static final int RANGE = 15;

    public VybranthymBowItem(Item.Settings settings) {
        super(settings);
    }
            ...
            if (!itemStack.isEmpty() || bl) {
                ...
                if (!((double)f < 0.1)) {
                    ...
                    if (!world.isClient) {
                        ...
                        if (j > 0) {
                            persistentProjectileEntity.setDamage(persistentProjectileEntity.getDamage() + (double)j * 1.1 + 1.0);
                        }
